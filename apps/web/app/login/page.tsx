    ...
    <main className="flex h-[100dvh] flex-col items-center justify-center p-6 relative overflow-hidden">
      ...
      <GlassContainer className="w-full max-w-md p-10 flex flex-col gap-8">
        ...
        <form onSubmit={handleLogin} className="flex flex-col gap-5">
          ...
          <Link href="/forgot-password" className="text-center text-white/55 hover:text-white/80 text-[10px] uppercase tracking-[0.3em] font-bold transition-colors py-2 px-1">
            Forgot password?
          </Link>
        </form>
