        ...
        {sent ? (
          ...
          <form onSubmit={submit} className="flex flex-col gap-5">
            <div className="flex flex-col gap-2">
              <label htmlFor="forgot-email" className="text-[10px] uppercase tracking-widest text-white/70 ml-1 font-bold">Email Address</label>
              <input
                id="forgot-email"
                type="email"
                required
                ...
                className="bg-white/5 border border-white/10 rounded-xl px-4 py-4 text-sm text-white placeholder:text-white/45 focus:outline-none focus:border-white/40 transition-all"
              />
            </div>
            {/* Decision-critical info BEFORE submit, not after. */}
            <p className="text-[11px] text-rose-300/70 leading-relaxed bg-rose-950/20 border border-rose-500/15 rounded-xl p-3">
              Because your password protects your encryption keys, after a reset you&apos;ll need your <b>recovery code</b> to unlock your message history on a device.
            </p>
